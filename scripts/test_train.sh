...
python train.py --attention_kernel=power --chunk_size=128 --batch_size=2 --block_size=1024 --max_iters=100 --run_name=ci/power_retention/$CURRENT_COMMIT --data_root=/shared/datasets $LOGGING_FLAG
