    ...
    if ((BLOCK_D == 128) and ((BLOCK_T == 16) and ((block1 == 16)))) or ((BLOCK_D == 128) and ((BLOCK_T == 32) and ((block1 == 16)))):
        ...
        for m in range(0, d//block1):
            ...
            for n in range(0, (m+1)*block1//block2):
                ...
                p_phi_K_0 = phi_K + range_t[:, None] * stride_pt + (off_D + 0 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_1 = K + range_t[:] * stride_kt + (off_d2 + 1) * stride_kd # [BLOCK_T]
                p_phi_K_1 = phi_K + range_t[:, None] * stride_pt + (off_D + 1 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_2 = K + range_t[:] * stride_kt + (off_d2 + 2) * stride_kd # [BLOCK_T]
                p_phi_K_2 = phi_K + range_t[:, None] * stride_pt + (off_D + 2 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_3 = K + range_t[:] * stride_kt + (off_d2 + 3) * stride_kd # [BLOCK_T]
                p_phi_K_3 = phi_K + range_t[:, None] * stride_pt + (off_D + 3 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_4 = K + range_t[:] * stride_kt + (off_d2 + 4) * stride_kd # [BLOCK_T]
                p_phi_K_4 = phi_K + range_t[:, None] * stride_pt + (off_D + 4 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_5 = K + range_t[:] * stride_kt + (off_d2 + 5) * stride_kd # [BLOCK_T]
                p_phi_K_5 = phi_K + range_t[:, None] * stride_pt + (off_D + 5 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_6 = K + range_t[:] * stride_kt + (off_d2 + 6) * stride_kd # [BLOCK_T]
                p_phi_K_6 = phi_K + range_t[:, None] * stride_pt + (off_D + 6 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_7 = K + range_t[:] * stride_kt + (off_d2 + 7) * stride_kd # [BLOCK_T]
                p_phi_K_7 = phi_K + range_t[:, None] * stride_pt + (off_D + 7 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                ...
                phik_2 = k_d1 * k_d2_2[:, None] # [BLOCK_T x block1]
                phik_3 = k_d1 * k_d2_3[:, None] # [BLOCK_T x block1]
                phik_4 = k_d1 * k_d2_4[:, None] # [BLOCK_T x block1]
                phik_5 = k_d1 * k_d2_5[:, None] # [BLOCK_T x block1]
                phik_6 = k_d1 * k_d2_6[:, None] # [BLOCK_T x block1]
                phik_7 = k_d1 * k_d2_7[:, None] # [BLOCK_T x block1]
        ...
        for m in range(0, d//block1):
            ...
            for n in range(0, (m+1)*block1//block2):
                ...
                p_phi_K_8 = phi_K + range_t[:, None] * stride_pt + (off_D + 8 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_9 = K + range_t[:] * stride_kt + (off_d2 + 9) * stride_kd # [BLOCK_T]
                p_phi_K_9 = phi_K + range_t[:, None] * stride_pt + (off_D + 9 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_10 = K + range_t[:] * stride_kt + (off_d2 + 10) * stride_kd # [BLOCK_T]
                p_phi_K_10 = phi_K + range_t[:, None] * stride_pt + (off_D + 10 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_11 = K + range_t[:] * stride_kt + (off_d2 + 11) * stride_kd # [BLOCK_T]
                p_phi_K_11 = phi_K + range_t[:, None] * stride_pt + (off_D + 11 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_12 = K + range_t[:] * stride_kt + (off_d2 + 12) * stride_kd # [BLOCK_T]
                p_phi_K_12 = phi_K + range_t[:, None] * stride_pt + (off_D + 12 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_13 = K + range_t[:] * stride_kt + (off_d2 + 13) * stride_kd # [BLOCK_T]
                p_phi_K_13 = phi_K + range_t[:, None] * stride_pt + (off_D + 13 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_14 = K + range_t[:] * stride_kt + (off_d2 + 14) * stride_kd # [BLOCK_T]
                p_phi_K_14 = phi_K + range_t[:, None] * stride_pt + (off_D + 14 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                p_k_d2_15 = K + range_t[:] * stride_kt + (off_d2 + 15) * stride_kd # [BLOCK_T]
                p_phi_K_15 = phi_K + range_t[:, None] * stride_pt + (off_D + 15 * block1 + tl.arange(0, block1)[None, :]).to(tl.int64) * stride_pD # [BLOCK_T x block1]
                k_d2_0 = tl.load(p_k_d2_0) * multiplier # [BLOCK_T]
                k_d2_1 = tl.load(p_k_d2_1) * multiplier # [BLOCK_T]
                k_d2_2 = tl.load(p_k_d2_2) * multiplier # [BLOCK_T]
                k_d2_3 = tl.load(p_k_d2_3) * multiplier # [BLOCK_T]
                ...
                phik_6 = k_d1 * k_d2_6[:, None] # [BLOCK_T x block1]
                phik_7 = k_d1 * k_d2_7[:, None] # [BLOCK_T x block1]
                phik_8 = k_d1 * k_d2_8[:, None] # [BLOCK_T x block1]
                phik_9 = k_d1 * k_d2_9[:, None] # [BLOCK_T x block1]
                phik_10 = k_d1 * k_d2_10[:, None] # [BLOCK_T x block1]
                phik_11 = k_d1 * k_d2_11[:, None] # [BLOCK_T x block1]
                phik_12 = k_d1 * k_d2_12[:, None] # [BLOCK_T x block1]
                phik_13 = k_d1 * k_d2_13[:, None] # [BLOCK_T x block1]
                phik_14 = k_d1 * k_d2_14[:, None] # [BLOCK_T x block1]
                phik_15 = k_d1 * k_d2_15[:, None] # [BLOCK_T x block1]
                tl.store(p_phi_K_0, phik_0)
                tl.store(p_phi_K_1, phik_1)
                tl.store(p_phi_K_2, phik_2)
                tl.store(p_phi_K_3, phik_3)
