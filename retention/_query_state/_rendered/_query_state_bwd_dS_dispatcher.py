...
def _query_state_bwd_dS(Q, L, M, dO, Delta, dS, dSK,
    ...
    elif ((BLOCK_D == 64) and ((BLOCK_E == 32) and ((BLOCK_T == 16) and ((block1 == 16))))) or (((BLOCK_D == 64) and ((BLOCK_E == 32) and ((BLOCK_T == 32) and ((block1 == 16))))) or (((BLOCK_D == 64) and ((BLOCK_E == 64) and ((BLOCK_T == 16) and ((block1 == 16))))) or ((BLOCK_D == 64) and ((BLOCK_E == 64) and ((BLOCK_T == 32) and ((block1 == 16))))))):
